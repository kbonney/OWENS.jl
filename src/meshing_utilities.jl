...
function create_mesh_struts(;
    ...
    for ibld = 1:nblade
        ...
        for istrut = 1:Nstrut
            ...
            jointconn[ibld+nblade*(Nstrut+1+istrut), :] =
                [s2b_idx[ibld, istrut] b2s_idx[ibld, istrut]]
        end
    end
    ...
    #Joint Number,   Joint Connections, Joint Type, Joint Mass, Not Used, Psi_D, Theta_D
    myjoint =
        [Float64.(1:1:njoint) jointconn jointtype zeros(njoint) zeros(njoint) Psi_d_joint Theta_d_joint]
